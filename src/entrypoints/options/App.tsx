...
export default function App() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-8 text-foreground bg-background min-h-screen">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Walk up the DOM to build a path like <code>form &gt; div &gt; button</code>. Disable
                for just the element itself.
              </p>
            </div>
            <Switch
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label className="flex items-center gap-2 cursor-pointer text-sm">
                <input
                  ...
                  onChange={() => setNetworkFilter((n) => ({ ...n, mode: "xhr-fetch" }))}
              ...
              <label className="flex items-center gap-2 cursor-pointer text-sm">
                <input
                  ...
                  onChange={() => setNetworkFilter((n) => ({ ...n, mode: "all" }))}
                  className="accent-primary"
                />
                All resources{" "}
                <span className="text-muted-foreground">
                  (includes static assets — high volume)
                </span>
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="/analytics/*, */health, api.example.com/track"
              value={exclusionText}
      ...
      <section className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <Input
              id="custom-headers"
              placeholder="X-Api-Key, X-Auth-Token"
